...
def curl_get_embedding(
    ...
    if isinstance(input, str):
        ...
        raise TypeError(
            "Input must be a string or list of strings that represent raw input to be encoded."
        )

    data = {"model": model_name, "input": input_as_list, "encoding_format": "float"}
