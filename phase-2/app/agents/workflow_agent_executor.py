...
class WorkflowAgentExecutor(AgentExecutor):
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue) -> None:
        ...
        try:
            ...
            orchestration_prompt = f"""You received this alert:

{alert_diagnostics}

Please try to remediate the issue described in the alert and generate a report. Start by updating the context of the alert and then try to remediate the issue so other agents can help you."""
            ...
            response_text = json.dumps(state["report"])

            # TODO: Can return a dict with the report.
