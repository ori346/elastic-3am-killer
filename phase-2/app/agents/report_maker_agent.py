...
MODEL = os.getenv(
    "REPORT_MAKER_AGENT_MODEL", os.getenv("MODEL")
)
...
async def get_context_field(ctx: Context, field: str) -> str:
    """Get a specific field directly from context without LLM processing.

    Use this for fields that don't need interpretation - just copy the value
