...
def execute_oc_get_deployment_resources(
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            return f"Resource configuration for deployment '{deployment_name}':\n{output}"
        else:
...
@track_tool_usage
def execute_oc_describe_deployment(
    deployment_name: str, namespace: str
) -> str:
    """
...
tools = [
    ...
    FunctionTool.from_defaults(
        ...
        Required Inputs:
        - deployment_name (str): Name of the deployment (e.g., "microservice-b")
        - namespace (str): OpenShift namespace (e.g., "integration-test")
    ...
    FunctionTool.from_defaults(
        ...
        Required Inputs:
        - pod_name (str): Name of the pod (supports partial names like "microservice-b")
        ...
        Features:
        - Supports partial pod names (e.g., "microservice-b" matches "microservice-b-698f45c955-hbkjz")
