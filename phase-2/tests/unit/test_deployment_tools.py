...
def parse_tool_result(
    json_str: str,
) -> Union[DeploymentListResult, DeploymentResources, DeploymentDetail, ToolError]:
    ...
    try:
        ...
        if tool_name == "oc_get_deployments" and "deployments" in data:
            return DeploymentListResult(**data)
        elif tool_name == "oc_get_deployment_resources" and "containers" in data:
            return DeploymentResources(**data)
        elif tool_name == "oc_describe_deployment" and "conditions" in data:
            return DeploymentDetail(**data)
        else:
            # Try to determine by structure
            if "deployments" in data:
                return DeploymentListResult(**data)
            elif "containers" in data and "ready_replicas" in data:
                return DeploymentResources(**data)
...
class TestExecuteOcGetDeployments:
    """Test oc_get_deployments function"""
    ...
    def test_get_deployments_success(self, mock_run_oc, sample_deployment_json):
        ...
        result_json = oc_get_deployments("test-namespace")
        ...
        assert result.tool_name == "oc_get_deployments"
    ...
    def test_get_deployments_empty_list(self, mock_run_oc):
        ...
        result_json = oc_get_deployments("empty-namespace")
        result = parse_tool_result(result_json)
    ...
    def test_get_deployments_not_found_error(self, mock_run_oc):
        ...
        result_json = oc_get_deployments("missing")
        result = parse_tool_result(result_json)
    ...
    def test_get_deployments_permission_error(self, mock_run_oc):
        ...
        result_json = oc_get_deployments("production")
        result = parse_tool_result(result_json)
    ...
    def test_get_deployments_timeout_error(self, mock_run_oc):
        ...
        result_json = oc_get_deployments("test-ns")
        result = parse_tool_result(result_json)
...
class TestExecuteOcGetDeploymentResources:
    """Test oc_get_deployment_resources function"""
    ...
    def test_get_deployment_resources_success(
        ...
        result_json = oc_get_deployment_resources("frontend", "test-namespace")
        result = parse_tool_result(result_json)

        # Should be DeploymentResources, not ToolError
        assert isinstance(result, DeploymentResources)
        assert result.tool_name == "oc_get_deployment_resources"
        assert result.namespace == "test-namespace"
    ...
    def test_get_deployment_resources_not_found(self, mock_run_oc):
        ...
        result_json = oc_get_deployment_resources("missing", "test-ns")
    ...
    def test_get_deployment_resources_timeout(self, mock_run_oc):
        ...
        result_json = oc_get_deployment_resources("slow-deploy", "test-ns")
    ...
    def test_get_deployment_resources_json_error(self, mock_run_oc):
        ...
        result_json = oc_get_deployment_resources("broken", "test-ns")
...
class TestExecuteOcDescribeDeployment:
    """Test oc_describe_deployment function"""
    ...
    def test_describe_deployment_success(self, mock_run_oc, sample_deployment_json):
            ...
            **sample_deployment_json,
            "spec": {
                **sample_deployment_json["spec"],
                ...
                "selector": {"matchLabels": {"app": "frontend", "version": "v1"}},
            },
            "metadata": {
        ...
        result_json = oc_describe_deployment("frontend", "test-namespace")

        result = parse_tool_result(result_json)

        # Should be DeploymentDetail, not ToolError
        assert isinstance(result, DeploymentDetail)
        assert result.tool_name == "oc_describe_deployment"
        assert result.namespace == "test-namespace"
    ...
    def test_describe_deployment_not_found(self, mock_run_oc):
        ...
        result_json = oc_describe_deployment("missing", "test-ns")
    ...
    def test_describe_deployment_permission_error(self, mock_run_oc):
        ...
        result_json = oc_describe_deployment("secure-app", "secure")
    ...
    def test_describe_deployment_timeout(self, mock_run_oc):
        ...
        result_json = oc_describe_deployment("slow-deploy", "test-ns")
    ...
    def test_describe_deployment_unexpected_error(self, mock_run_oc):
        ...
        result_json = oc_describe_deployment("error-deploy", "test-ns")
...
class TestDeploymentToolsIntegration:
    ...
    def test_deployment_missing_fields_handling(self, mock_run_oc):
        ...
        result_json = oc_get_deployment_resources("minimal", "test")
    ...
    def test_deployment_error_classification_integration(self, mock_run_oc):
        ...
        for error_msg, expected_type, expected_recoverable in test_cases:
            ...
            result_json = oc_get_deployments("test")
            result = parse_tool_result(result_json)
