...
An intelligent multi-agent system for automated incident remediation in OpenShift/Kubernetes environments. The system uses LLM-powered agents to diagnose issues, execute remediation commands, and generate comprehensive reports - so you don't have to wake up at 3 AM.
...
```bash
export MICROSERVICES_INFO=$(cat microservices.txt)
